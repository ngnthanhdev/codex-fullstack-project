...
- [ ] Scaffold runnable Expo app code in `apps/mobile` when ready.
- [ ] Scaffold runnable NestJS app code in `apps/api` when ready.
- [ ] Define API base URL configuration for mobile.
